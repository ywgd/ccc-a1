    ...
    try:
        with open(twitterFilePath,'rb') as f:
            ...
            for line in iter(mmp.readline,b''):
                count +=1
                if twitterFilePath!='bigTwitter.json':# structure of bigTwitter File is different
...
def printFinalResult(gridLangMap):
    ...
    printFormat = '| {0:^5} | {1:^15} | {2:^25} | {3:^120} |'
...
def multiLanguageTest(gridLangMap):
    ...
    gridLangMap.gridLangList[5].langDict['ro'] = 100
    # langDict = languageListProcessor()
...
if __name__ == '__main__':
    ...
    mmapTwitterProcessor('tinyTwitter.json',1,gridLangMap)
    printFinalResult(gridLangMap)

    gridLangMap2 = gridProcessor('sydGrid.json')
    mmapTwitterProcessor('smallTwitter.json', 1, gridLangMap2)
    printFinalResult(gridLangMap2)

    # gridLangMap3=gridProcessor('sydGrid.json')
    # mmapTwitterProcessor('bigTwitter.json', 1, gridLangMap3)
    # printFinalResult(gridLangMap3)
